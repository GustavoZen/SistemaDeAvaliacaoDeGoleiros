...
public class principal {
	public static void printGolxo(CelulaGol[][] Gol) {
		for (int i = 0; i < 9; i++) {
			for (int j = 0; j < 17; j++) {
				if (Gol[i][j].situacao == true)
					System.out.print("o");
				else
					System.out.print("x");
			}
	...
	public static void printGolqdt(CelulaGol[][] gol) {
		for (int i = 0; i < 9; i++) {
			for (int j = 0; j < 17; j++) {
				System.out.print(gol[i][j].quadrante);
			}
			System.out.println();
		}
	}
	public static void main(String[] args) {
		...
		for (int i = 0; i < 9; i++) {
			for (int j = 0; j < 17; j++) {
				Gol[i][j] = new CelulaGol(0,0,0,false);
			}
		}
		definirGol(Gol);
		printGolxo(Gol);
